...
FEATURE_GROUPS = [
    ...
    },
    {
        ...
        "physical_process": "Non-thermal bremsstrahlung from accelerated electrons. Bands: b0-b4 = CZT (20-40, 40-60, 60-80, 80-150, 18-160 keV), b5-b9 = CdTe (5-20, 20-30, 30-40, 40-60, 1.8-90 keV). Hardness = high/lo ratio. CZT2/CdTe2 = second detector stats.",
        "flare_behavior": "All bands increase during flares. Higher bands (b2-b4, b7-b9) show larger relative increase = spectral hardening. b0 (20-40 keV) usually brightest. Hardness ratio increases (hardening). CZT2/CdTe2 track same trends.",
        ...
        "interpreting_values": {
            ...
            "hxr_hardness_ratio": "Ratio of HXR(40-60)/HXR(20-40). Increases during flare = spectral hardening.",
            "soft_hard_ratio": "Ratio of SXR/HXR. Decreases during flare (HXR grows faster).",
            "czt2_total_mean": "CZT2 full-band mean. Similar to CZT1 but independent detector.",
        },
    },
    {
    ...
    },
    {
        ...
        "n_features": 3,
        "features": ["deadtime_max_pct", "bg_fraction_pct", "window_len"],
